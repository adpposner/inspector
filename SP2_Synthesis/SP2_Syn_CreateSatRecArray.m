%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function  f_succ = SP2_Syn_CreateSatRecArray
%%
...
FCTNAME = 'SP2_Syn_CreateSatRecArray';
...
for srCnt = 1:mm.satRecN        % individual saturation-recovery experiments
    mm.fid(:,srCnt) = mm.syn.fid .* ...                                 % base FID
                      exp(-tVec/mm.syn.t2) * ...                        % T2
                      (1-exp(-mm.satRecDelays(srCnt)/mm.syn.t1));       % T1
    if flag.synSimNoise
