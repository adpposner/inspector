%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
function f_succ = SP2_Data_DatFidFileLoad(f_winUpdate,f_loadMsgFlag)
    %% 
    %%  Function to load 
    ...
    elseif flag.dataManu==2                                                         % Bruker
        ...
        elseif flag.dataExpType==3              % JDE
            ...
            %%%OVERRIDING TO USE FID FILE
            if endsWith(data.spec1.fidFile,'fid') || endsWith(data.spec1.fidFile,'refscan')
                flag.dataBrukerFormat = 2
            end
            %--- read data file ---
