%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [f_err,msg] = SP2_Data_SiemensRdaParsConsistency(meth1,meth2)
%%
...
FCTNAME = 'SP2_Data_SiemensRdaProcparConsistency';
                ...
                if isnumeric(par2)
                    if ndims(par1)==ndims(par2)
                        if ~any(size(par1)~=size(par2))
                            if par1~=par2
                                if ~strcmp('InstanceTime',char(meth1Names(icnt))) && ~strcmp('InstanceDate',char(meth1Names(icnt)))
