%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [f_err,msg] = SP2_Data_PvAcqpConsistency(meth1,meth2)
%%
...
FCTNAME = 'SP2_Data_PvAcqpConsistency';

f_err = 0;
msg   = '';

%--- remove fields ---
if isfield(meth1,'ACQ_scan_time')
    meth1 = rmfield(meth1,'ACQ_scan_time');
end
if isfield(meth2,'ACQ_scan_time')
    meth2 = rmfield(meth2,'ACQ_scan_time');
end
if isfield(meth1,'ACQ_time')
    meth1 = rmfield(meth1,'ACQ_time');
end
if isfield(meth2,'ACQ_time')
    meth2 = rmfield(meth2,'ACQ_time');
end
...
%                                     msg = sprintf('%s%s is not consistent %f - %f \n',msg,char(meth1Names(icnt)),par1,par2);
%                                     f_err = 1;
%                                 end
%                             end
%                         else
