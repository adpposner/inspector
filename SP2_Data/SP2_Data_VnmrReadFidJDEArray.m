%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [dataSpec,f_done] = SP2_Data_VnmrReadFidJDEArray(dataSpec)
%%
...
FCTNAME = 'SP2_Data_VnmrReadFidJDEArray';
...
if dataSpec.saveSep
    if strcmp(dataSpec.seqcon(3),'c')
        ...
        for jdeCnt = 1:dataSpec.njde                % JDE loop
            for rcvCnt = 1:dataSpec.nRcvrs
                fseek(fid,bhSize,'cof');            % skip the block header
                for nrCnt = 1:dataSpec.nr/dataSpec.njde
                    traceCnt = traceCnt + 1;
        ...
        elseif dataSpec.nr==1 && dataSpec.nRcvrs>1      % NR=1, nRcvrs>1
            ...
            if dataSpec.njde==2                         % regular (single) JDE experiment
                % orig. data format
                dataSpec.fid = reshape(datFidTmp,dataSpec.nspecC,dataSpec.nr/dataSpec.njde,...
                                       dataSpec.nRcvrs,dataSpec.njde);
