%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function SP2_Data_Convdta(FILENAME)
%%
%%  Conversion of digitally filtered Bruker Avance aquistion data to
%%  'analog' data format. Data vector length and file size are reduced
%%  accordingly
%%  
%%  Literature:
...
for iNX = 1:nx
    for iNY = 1:ny
        for iNI = 1:ni
            ...
            datConvdta = dataTmp2 .* exp(1i*phaseCorr*ANGTORAD);
