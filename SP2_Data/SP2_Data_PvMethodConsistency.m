%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [f_err,msg] = SP2_Data_PvMethodConsistency(meth1,meth2)
%%
...
FCTNAME = 'SP2_Data_PvMethodConsistency';
...
%                                     msg = SP2_Data_InconsistencyMessage(msg,char(meth1Names(icnt)));
...
%                         else
%                             f_err = 1;
%                             msg = sprintf('any size: %s%s is not consistent\n',msg,char(meth1Names(icnt)));
%                         end
%                     else
%                         f_err = 1;
%                         msg = sprintf('ndims: %s%s is not consistent\n',msg,char(meth1Names(icnt)));
%                     end
%                 else
%                     f_err = 1;
%                     msg = sprintf('nonnumeric: %s%s is not consistent\n',msg,char(meth1Names(icnt)));
%                 end
