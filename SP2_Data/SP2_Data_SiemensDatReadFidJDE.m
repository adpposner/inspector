%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [dataSpec, f_succ] = SP2_Data_SiemensDatReadFidJDE(dataSpec)
%%
...
if strcmp(dataSpec.softGeneration,'VB')
    ...
    [dataSpec, f_done] = SP2_Data_SiemensDatReadFidJdeVB(dataSpec);
elseif strcmp(dataSpec.softGeneration,'VD') || strcmp(dataSpec.softGeneration,'VE')
    ...
    [dataSpec, f_done] = SP2_Data_SiemensDatReadFidJdeVDVE(dataSpec);
end
