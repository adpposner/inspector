%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [dataSpec,f_done] = SP2_Data_VnmrReadFidMRSI(dataSpec)
%%
%%  Function to read Varian's JNMR fid data file of MRSI experiment.
%%  Note that .nr already contains all conditions, i.e. a 64 step JDE
%%  MRSI experiment with two conditions (edit ON/OFF) has a total .nr of
%%  64*2 = 128.
%%
...
FCTNAME = 'SP2_Data_VnmrReadFidMRSI';
...
%--- read data from file ---
if strcmp(procpar.seqcon(3),'s')            % standard

    %--- compressed mode: working! ---
