%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [dataSpec,f_done] = SP2_Data_VnmrReadFidStability(dataSpec)
%%
%%  function datFid = JnmrRdFid(file)
...
FCTNAME = 'SP2_Data_VnmrRdFidStability';
...
if dataSpec.saveSep             % STEAM (or other customized MRS method)
...
else            % spuls (or other predefined VNMRJ) method
