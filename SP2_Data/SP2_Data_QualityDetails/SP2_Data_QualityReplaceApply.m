...
%--- FID replacement ---
dataSpec1FidArr       = data.spec1.fidArr(:,:,data.rcvrInd,:);          % format: nblock x nspecC x nrcvrs x NR/block
dataSpec1FidArrRxComb = data.spec1.fidArrRxComb;                        % format: nblock x nspecC x NR/block
dataSpec1FidArrSerial = data.spec1.fidArrSerial;                        % format: nspecC x nblock*NR/block
for repCnt = 1:data.quality.replaceN
    ...
    data.spec1.fidArr(seriesCntExcl,:,:,nrCntExcl)          = dataSpec1FidArr(seriesCntRepl,:,:,nrCntRepl);
    data.spec1.fidArrRxComb(seriesCntExcl,:,nrCntExcl)      = dataSpec1FidArrRxComb(seriesCntRepl,:,nrCntRepl);
