...
fm.data.qualityDet.frequglobal loggingfile = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,'Units','Normalized','Value',flag.dataQualityFrequMode,...
                                           'String','global loggingfile','Position',[.39 .622 .20 .03],'Callback','SP2_Data_QualityFrequglobal loggingfileUpdate',...
                                           'TooltipString',sprintf('global loggingfile frequency range'));
...
fm.data.qualityDet.phaseZero    = uicontrol('Style','Edit','Position', [160 315 50 18],'String',num2str(data.quality.phaseZero),...
                                            'BackGroundColor',pars.bgColor,'Callback','SP2_Data_QualityParsUpdate',...
                                            'TooltipString','global loggingfile zero-order phase offset [deg]');
if flag.OS==1               % Linux
...
fm.data.qualityDet.cmapglobal loggingfile  = uicontrol('Style','Pushbutton','String','Match Range','Position',[160 260 85 18],'Callback','SP2_Data_QualityColormapMatch',...
