...
if ( fsize/NumBytes == (2*nspecC)*nx*ny*ns*ni*nr*nRcvrs)
    fprintf('reading <%s>\n', dataSpec.fidFile);
    fprintf('nspec/nx/ny/ns/ni/nr/nRcvrs: %d/%d/%d/%d/%d/%d/%d filesize %dk\n', ...
            2*nspecC,nx,ny,ns,ni,nr,nRcvrs,fsize/1024);
else
    fprintf('%s: nint %d ~= nspec*nx*ny*ni*ns*nr*nRcvrs = %d*%d*%d*%d*%d*%d*%d = %d\n', ...
...
fprintf('resorting to complex: dim nspecC/nx/ny/ns/ni/nr/nRcvrs: %d/%d/%d/%d/%d/%d/%d \n',...
