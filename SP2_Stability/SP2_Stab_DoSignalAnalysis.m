...
binStdComp = zeros(stab.ppmBins,stab.nr);         % comparison std.deviations: local vs. global loggingfile
...
if flag.stabTotSel
    ...
    meanstr = sprintf('global loggingfile: %.0f',stab.rangeStd(stab.specSel));
