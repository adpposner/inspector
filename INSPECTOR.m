...
% fprintf('pars.figPos(1) = %.0f\n',pars.figPos(1))
% fprintf('pars.figPos(2) = %.0f\n',pars.figPos(2))
...
fprintf('\n---   INSPECTOR   ---\n')
fprintf('Magnetic Resonance Spectroscopy Software\n')
fprintf('Version 11-2021\n')
fprintf('by Christoph Juchem\n')
fprintf('MR SCIENCE Laboratory\n')
