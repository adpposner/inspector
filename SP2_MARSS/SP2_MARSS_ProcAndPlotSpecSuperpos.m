%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function f_succ = SP2_MARSS_ProcAndPlotSpecSuperpos( f_new )
%%
%%  Process basis spectra and plot selected metabolite simulation results
%%  as supersposition.
%% 
...
%--- figure creation ---
if ~SP2_MARSS_PlotSpecSuperpos(f_new)             % forced new figure
    return
end
