%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function SP2_Proc_ProcAndPlotFidDiff( f_new )
%%
...
FCTNAME = 'SP2_Proc_ProcAndPlotFidDiff';
...
elseif ~isfield(proc,'fidDiff')
    fprintf('%s ->\nData does not exist. Load/reconstruct first.\n',FCTNAME)
    return
end

%--- figure creation ---
if ~SP2_Proc_PlotFidDiff(f_new)        % forced new figure
    return
end
