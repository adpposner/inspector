%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [pars, f_succ] = SP2_Check4IntR(pars,varargin)
%%
%%  function SP2_Check4IntR(pars)
...
%%  The only difference to SP2_Check4Int.m is that the number is return. So, when numbers are
%%  passed to other variables (e.g. number = SP2_Check4IntR(varargin{1}) ), no additional step 
