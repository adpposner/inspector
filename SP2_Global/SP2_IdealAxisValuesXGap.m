%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [MinX, MaxX, MinY, MaxY] = SP2_IdealAxisValuesXGap(varargin)
%%
...
%%  The only difference to IdealAxisValues.m is that for the x-axis there are gaps
%%  left which are +/-5% of the full x-axis dimension.
%%
%%  Christoph Juchem, 03-2003
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

FCTNAME = 'SP2_IdealAxisValuesXGap';


OffsetFac = 0.1;      % constant to determine the gap between the function and the window limit
xGap      = 0.05;     % x gap, e.g. 0.05 -> gap of 5% of the full x data range
...
%--- determine x-range ---
minXorig = MinX;
MinX = MinX - xGap*(MaxX-MinX);
MaxX = MaxX + xGap*(MaxX-minXorig);

%--- take enhanced y-range -------------------
