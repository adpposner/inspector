function [p,S,mu] = SP2_Polyfit2(x,y,n)
%POLYFIT Fit polynomial to data.
%
%   Function from MATLAB 2019a
%   08-2020, Martin Gajdosik
%   
...
% MAG
% Issue with warnIfLargeConditionNumber(R) in Matlab 2013b
% Added cond() function

% Issue warnings.
if size(R,2) > size(R,1)
    warning(message('MATLAB:polyfit:PolyNotUnique'))
elseif warnIfLargeConditionNumber(cond(R)) % MAG, added cond() function
    if nargout > 2
