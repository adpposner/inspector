...
if flag.OS==1               % Linux
    fm.lcm.fit.linkLb    = uicontrol('Style','Radiobutton','Units','Normalized','Position',[0.283 0.005 .04 .02],'String','Link', ...
                                     ...
                                     'TooltipString',sprintf('One global loggingfile vs metabolite-specific exponential line broadening'),'FontSize',pars.fontSize);
    fm.lcm.fit.linkGb    = uicontrol('Style','Radiobutton','Units','Normalized','Position',[0.442 0.005 .04 .02],'String','Link', ...
                                     ...
                                     'TooltipString',sprintf('One global loggingfile vs metabolite-specific Gaussian line broadening'),'FontSize',pars.fontSize);
    fm.lcm.fit.linkShift = uicontrol('Style','Radiobutton','Units','Normalized','Position',[0.601 0.005 .04 .02],'String','Link', ...
                                     ...
                                     'TooltipString',sprintf('One global loggingfile vs metabolite-specific frequency shift determination'),'FontSize',pars.fontSize);
elseif flag.OS==2           % Mac
