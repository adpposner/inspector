%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function  f_succ = SP2_LCM_SpecDataLoadFromProcPage
%% 
...
FCTNAME = 'SP2_LCM_SpecDataLoadFromProcPage';
...
if isfield(proc.expt,'nspecC')
    lcm.nspecCOrig = proc.expt.nspecC;       % number of complex data points (to be modified: cut, ZF)
    lcm.nspecC     = proc.expt.nspecC;
else
...
if isfield(proc.expt,'sw_h')
    lcm.sw_h  = proc.expt.sw_h;                 % sweep width in Hz
