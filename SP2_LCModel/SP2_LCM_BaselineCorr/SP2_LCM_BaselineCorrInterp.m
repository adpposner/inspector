%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
    function [datStruct,f_done] = SP2_LCM_BaselineCorrInterp( specNumber, f_apply )
%%
...
for winCnt = 1:lcm.baseInterpPpmN
    [minPpmIndVec(winCnt),maxPpmIndVec(winCnt),ppmZoom,specZoom,f_done] = ...
        SP2_LCM_ExtractPpmRange(lcm.baseInterpPpmMin(winCnt),lcm.baseInterpPpmMax(winCnt),...
