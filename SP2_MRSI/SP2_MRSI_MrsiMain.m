...
%% 
%%  Main window for MRSI processing.
%%
%%  04-2014, Christoph Juchem
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

global loggingfile fm fmfig pars flag mrsi


SP2_ClearWindow
flag.fmWin = 6;
figPos = get(fmfig,'Position');
set(fmfig,'Name',' INSPECTOR: MR Spectroscopic Imaging','Position',...
...
fm.mrsi.datMrsi = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,'Units','Normalized','String','MRSI', ...
                            'Value',flag.mrsiData==1,'Position',[.32 .96 .08 .03],'Callback','SP2_MRSI_DataMrsiUpdate');
...
%******************************************************************************
%--- data set 1 ---
fm.mrsi.spec1DataLab    = text('Position',[-0.145, 1.027],'String','Spec 1');
if flag.mrsiDatFormat       % matlab format
    fm.mrsi.spec1DataPath   = uicontrol('Style','Edit','Position', [60 657 440 18],'String',mrsi.spec1.dataPathMat,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_Spec1DataPathUpdate');
else                        % text format 
    fm.mrsi.spec1DataPath   = uicontrol('Style','Edit','Position', [60 657 440 18],'String',mrsi.spec1.dataPathTxt,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_Spec1DataPathUpdate');
end
fm.mrsi.spec1DataSelect = uicontrol('Style','Pushbutton','String','Select',...
                                    'Position',[500 657 45 18],'Callback','SP2_MRSI_Spec1DataSelect');
fm.mrsi.spec1DataLoad   = uicontrol('Style','Pushbutton','String','Load','Position',[545 657 45 18],...
                                    'Callback','SP2_MRSI_DataAndParsAssign1;');

%--- data set 2 ---
fm.mrsi.spec2DataLab    = text('Position',[-0.145, 0.996],'String','Spec 2');
if flag.mrsiDatFormat       % matlab format
    fm.mrsi.spec2DataPath   = uicontrol('Style','Edit','Position', [60 639 440 18],'String',mrsi.spec2.dataPathMat,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_Spec2DataPathUpdate');
else                        % text format 
    fm.mrsi.spec2DataPath   = uicontrol('Style','Edit','Position', [60 639 440 18],'String',mrsi.spec2.dataPathTxt,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_Spec2DataPathUpdate');
end
fm.mrsi.spec2DataSelect = uicontrol('Style','Pushbutton','String','Select',...
                                    'Position',[500 639 45 18],'Callback','SP2_MRSI_Spec2DataSelect');
fm.mrsi.spec2DataLoad   = uicontrol('Style','Pushbutton','String','Load','Position',[545 639 45 18],...
                                    'Callback','SP2_MRSI_DataAndParsAssign2;');
                            
%--- reference ---
fm.mrsi.refDataLab    = text('Position',[-0.145, 0.965],'String','Ref');
if flag.mrsiDatFormat       % matlab format
    fm.mrsi.refDataPath   = uicontrol('Style','Edit','Position', [60 621 440 18],'String',mrsi.ref.dataPathMat,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_RefDataPathUpdate');
else                        % text format 
    fm.mrsi.refDataPath   = uicontrol('Style','Edit','Position', [60 621 440 18],'String',mrsi.ref.dataPathTxt,...
                                        'HorizontalAlignment','Left','Callback','SP2_MRSI_RefDataPathUpdate');
end
fm.mrsi.refDataSelect = uicontrol('Style','Pushbutton','String','Select',...
                                  'Position',[500 621 45 18],'Callback','SP2_MRSI_RefDataSelect');
fm.mrsi.refDataLoad   = uicontrol('Style','Pushbutton','String','Load','Position',[545 621 45 18],...
                                  'Callback','SP2_MRSI_DataAndParsAssignRef;');

%--- export data ---
fm.mrsi.exptDataLab    = text('Position',[-0.145, 0.934],'String','Export');
if flag.mrsiDatFormat       % matlab format
    fm.mrsi.exptDataPath   = uicontrol('Style','Edit','Position', [60 603 440 18],'String',mrsi.expt.dataPathMat,...
                                       'HorizontalAlignment','Left','Callback','SP2_MRSI_ExptDataPathUpdate');
else                        % text format 
    fm.mrsi.exptDataPath   = uicontrol('Style','Edit','Position', [60 603 440 18],'String',mrsi.expt.dataPathTxt,...
                                       'HorizontalAlignment','Left','Callback','SP2_MRSI_ExptDataPathUpdate');
end
fm.mrsi.exptDataSelect = uicontrol('Style','Pushbutton','String','Select',...
                                   'Position',[500 603 45 18],'Callback','SP2_MRSI_ExptDataSelect');
fm.mrsi.exptDataSave   = uicontrol('Style','Pushbutton','String','Save','Position',[545 603 45 18],...
...
%--- spatial filter ---
fm.mrsi.spatFiltLab  = text('Position',[0.56, 0.8930],'String','Filter');
fm.mrsi.spatFiltFlag = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,...
                                 'FontSize',10,'Units','Normalized','Value',flag.mrsiSpatFilt==1,...
                                 'Position',[.65 .822 .03 .03],'Callback','SP2_MRSI_SpatFiltFlagUpdate',...
                                 'TooltipString',sprintf('Include spatial filter function in MRSI processing'));
 
%--- ECC ---
fm.mrsi.eccLab  = text('Position',[0.77, 0.8930],'String','ECC');
fm.mrsi.eccFlag = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,...
                            'FontSize',10,'Units','Normalized','Value',flag.mrsiEcc==1,...
                            'Position',[.79 .822 .03 .03],'Callback','SP2_MRSI_EccFlagUpdate',...
                            'TooltipString',sprintf('Include eddy-current correction with reference data set in MRSI processing'));

%--- baseline correction ---
fm.mrsi.baseCorrLab  = text('Position',[0.92, 0.8930],'String','BaseCorr');
fm.mrsi.baseCorrFlag = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,...
                                 'FontSize',10,'Units','Normalized','Value',flag.mrsiBaseCorr==1,...
                                 'Position',[.95 .822 .03 .03],'Callback','SP2_MRSI_BaselineCorrFlagUpdate',...
                                 'TooltipString',sprintf('Include baseline correction\n(compare baseline correction sheet for details)'));
 
%--- spatial zero-filling ---
fm.mrsi.spatZfLab   = text('Position',[0.56, 0.8491],'String','Spat ZF');
fm.mrsi.spatZfFlag  = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,...
                                'FontSize',10,'Units','Normalized','Value',flag.mrsiSpatZF==1,...
                                'Position',[.65 .7864 .03 .03],'Callback','SP2_MRSI_SpatZeroFillFlagUpdate',...
                                'TooltipString',sprintf('Spatial zero-filling [pts]'));
fm.mrsi.spatZfVal   = uicontrol('Style','Edit','Position', [419 555 55 18],'String',sprintf('%.0f',mrsi.spatZF),...
                                'BackGroundColor',pars.bgColor,'Callback','SP2_MRSI_SpatZeroFillUpdate');
...
%--- spectral processing ---
fm.mrsi.plotFid1Orig = uicontrol('Style','Pushbutton','String','FID 1 Orig','FontWeight','bold','Position',[10 60 80 20],...
                                 'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ProcAndPlotFid1Orig');
fm.mrsi.plotFid2Orig = uicontrol('Style','Pushbutton','String','FID 2 Orig','FontWeight','bold','Position',[95 60 80 20],...
                                 'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ProcAndPlotFid2Orig');
fm.mrsi.plotFid1     = uicontrol('Style','Pushbutton','String','FID 1','FontWeight','bold','Position',[10 40 80 20],...
                                 'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ProcAndPlotFid1');
fm.mrsi.plotFid2     = uicontrol('Style','Pushbutton','String','FID 2','FontWeight','bold','Position',[95 40 80 20],...
...
fm.mrsi.specSuperpos = uicontrol('Style','Pushbutton','String','Spec Super','FontWeight','bold','Position',[180 60 90 20],...
                                 'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ProcAndPlotSpecSuperpos');
fm.mrsi.specSum      = uicontrol('Style','Pushbutton','String','Spec Sum','FontWeight','bold','Position',[180 40 90 20],...
                                 'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ProcAndPlotSpecSum');
fm.mrsi.specDiff     = uicontrol('Style','Pushbutton','String','Spec Diff','FontWeight','bold','Position',[180 20 90 20],...
...
fm.mrsi.updateCalc   = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,'Units','Normalized','String','Update', ...
                                 'Value',flag.mrsiUpdateCalc,'Position',[.46 .085 .12 .03],'Callback','SP2_MRSI_UpdateCalcUpdate',...
...
fm.mrsi.keepFigure   = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,'Units','Normalized','String','Keep', ...
                                 'Value',flag.mrsiKeepFig,'Position',[.46 .055 .10 .03],'Callback','SP2_MRSI_KeepFigureUpdate',...
...
fm.mrsi.verbose      = uicontrol('Style','RadioButton','BackGroundColor',pars.bgColor,'Units','Normalized','Value',flag.verbose,...
                                 'String','Verbose','Position',[0.46 0.025 .17 .03],'Callback','SP2_MRSI_VerboseFlagUpdate');

%--- single spectrum selection (left/right, posterior/anterior) ---
fm.mrsi.selectLrLab  = text('Position',[0.52, 0.104],'String','L/R');
fm.mrsi.selectLrDecr = uicontrol('Style','Pushbutton','String','-','Position',[350 130 20 18],'FontWeight','bold','Callback','SP2_MRSI_SelectLrDecr');
fm.mrsi.selectLR     = uicontrol('Style','Edit','Position', [370 130 40 18],'String',sprintf('%.0f',mrsi.selectLR),'BackGroundColor',pars.bgColor,'Callback','SP2_MRSI_SelectLrUpdate');
fm.mrsi.selectLrIncr = uicontrol('Style','Pushbutton','String','+','Position',[410 130 20 18],'FontWeight','bold','Callback','SP2_MRSI_SelectLrIncr');
fm.mrsi.selectPaLab  = text('Position',[0.81, 0.104],'String','P/A');
fm.mrsi.selectPaDecr = uicontrol('Style','Pushbutton','String','-','Position',[490 130 20 18],'FontWeight','bold','Callback','SP2_MRSI_SelectPaDecr');
fm.mrsi.selectPA     = uicontrol('Style','Edit','Position', [510 130 40 18],'String',sprintf('%.0f',mrsi.selectPA),'BackGroundColor',pars.bgColor,'Callback','SP2_MRSI_SelectPaUpdate');
fm.mrsi.selectPaIncr = uicontrol('Style','Pushbutton','String','+','Position',[550 130 20 18],'FontWeight','bold','Callback','SP2_MRSI_SelectPaIncr');
                             
%--- spectrum combinations ---
fm.mrsi.showKSpaceEnc = uicontrol('Style','Pushbutton','String','Encoding','FontWeight','bold','Position',[355 80 115 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowKSpaceEncode',...
                                  'TooltipString',sprintf('Show k-space encoding'));
fm.mrsi.showKSpaceMat = uicontrol('Style','Pushbutton','String','k-Space','FontWeight','bold','Position',[475 80 115 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowKSpaceMat',...
                                  'TooltipString',sprintf('Show raw k-space data'));
fm.mrsi.mrsiAnalysis  = uicontrol('Style','Pushbutton','String','Process MRSI','FontWeight','bold','Position',[355 60 235 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_MrsiAnalysis;',...
                                  'TooltipString',sprintf('Perform spatio-spectral MRSI analysis according to above parameter selections'));
fm.mrsi.showFidMat    = uicontrol('Style','Pushbutton','String','FID Matrix','FontWeight','bold','Position',[355 40 115 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowFidImg(1)',...
                                  'TooltipString',sprintf('Show FID matrix'));
fm.mrsi.showFidMrsi   = uicontrol('Style','Pushbutton','String','FID MRSI','FontWeight','bold','Position',[475 40 115 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowFidMrsi(1)',...
                                  'TooltipString',sprintf('Show basic FID MRSI\n(integration of 1:cut magnitude FID points)'));
fm.mrsi.showSpecMat1   = uicontrol('Style','Pushbutton','String','Spec Mat 1','FontWeight','bold','Position',[355 20 75 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpec1Img(1)',...
                                  'TooltipString',sprintf('Show Spectral matrix'));
fm.mrsi.showSpecMat2   = uicontrol('Style','Pushbutton','String','2','FontWeight','bold','Position',[430 20 20 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpec2Img(1)',...
                                  'TooltipString',sprintf('Show Spectral matrix'));
fm.mrsi.showSpecMatDiff = uicontrol('Style','Pushbutton','String','D','FontWeight','bold','Position',[450 20 20 20],...
                                   'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpecDiffImg(1)',...
                                   'TooltipString',sprintf('Show Spectral matrix'));
fm.mrsi.showMrsi1     = uicontrol('Style','Pushbutton','String','Spec MRSI 1','FontWeight','bold','Position',[475 20 75 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpec1Mrsi(1)',...
                                  'TooltipString',sprintf('Show MRSI based on integration of spectral data set 1'));
fm.mrsi.showMrsi2     = uicontrol('Style','Pushbutton','String','2','FontWeight','bold','Position',[550 20 20 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpec2Mrsi(1)',...
                                  'TooltipString',sprintf('Show MRSI based on integration of spectral data set 2'));
fm.mrsi.showMrsiDiff  = uicontrol('Style','Pushbutton','String','D','FontWeight','bold','Position',[570 20 20 20],...
                                  'FontSize',pars.fontSize,'FontName','Helvetica','Callback','SP2_MRSI_ShowSpecDiffMrsi(1)',...
                                  'TooltipString',sprintf('Show MRSI based on integration of difference spectra'));
