...
if flag.mrsiDatFormat       % matlab format
    ...
    set(fm.mrsi.refDataPath,'String',mrsi.ref.dataPathMat)
    ...
    set(fm.mrsi.refDataPath,'String',mrsi.ref.dataPathTxt)
...
if flag.mrsiData            % directly from processing sheet
    ...
    set(fm.mrsi.refDataPath,'Enable','on')
    set(fm.mrsi.refDataSelect,'Enable','on')
else                        % from data sheet
    set(fm.mrsi.spec1DataPath,'Enable','off')
    set(fm.mrsi.spec1DataSelect,'Enable','off')
    set(fm.mrsi.refDataPath,'Enable','off')
    set(fm.mrsi.refDataSelect,'Enable','off')
end
